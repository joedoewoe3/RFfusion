...
# Public API
export send_packet_serial, receive_packet_serial, open_node, close_node, lattice_dict # init_lattice_dict  From latticenode.jl
export create_raw_packet, create_filtered_packet, encode_packet, decode_packet, compute_crc32, make_header  # From PacketUtils.jl
